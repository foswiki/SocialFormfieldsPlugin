...
package Foswiki::Form::Socialradio;
...
sub new {
  return shift->Foswiki::Form::Radio::new(@_);
}

sub renderForEdit {
  return shift->Foswiki::Form::Radio::renderForEdit(@_);
}

sub getOptions {
  return shift->Foswiki::Form::Radio::getOptions(@_);
}
